...
apache ALL=(ALL) NOPASSWD: /usr/bin/hdhomerun_config,/usr/bin/chown,/usr/bin/realpath,/usr/bin/sed, /usr/bin/tail, /usr/bin/ffprobe, /usr/bin/chmod,/usr/bin/screen,/usr/bin/mkfifo, /usr/bin/mediainfo, /usr/bin/screen, /usr/bin/echo, /usr/bin/mkdir, /usr/bin/bash, /usr/bin/ffmpeg, /usr/bin/rm, /usr/bin/awk
#+end_src
...
Put =index.php= and =hdhomerunstream.php= in a directory under the web server root,
preferably create one at =/var/www/html/mythtv-stream-hls-dash/=.
