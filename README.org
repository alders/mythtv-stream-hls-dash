...
This option is only shown when [[https://www.mythtv.org/wiki/Editing_Recordings][commercials are manually cut]] in =mythfrontend=.
...
machine this allows one to have full control your from your browser.
